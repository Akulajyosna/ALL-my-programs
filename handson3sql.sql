...
from orders ,customers where orders.customer_id=customers.customer_id and purch_amt between 500 and 2000
select salesman.name,customers.cust_name, customers.city from salesman,customers where salesman.city=customers.city
